---
title: "C5 - Effects of the scale PubPress adjusted for the base set"
author: "Gerko Vink"
date: ""
output: 
   html_document:
...
fit <- d50 %>% 
  map(lm, formula = RRP_ave ~ PubPress + Field + Rank + Gender + Research + Support) 
...
# Multiply imputed repeated analysis 
fit <- d50 %>% 
  map(lm, formula = QRP_ave ~ PubPress + Field + Rank + Gender + Research + Support) 
